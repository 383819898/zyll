 ...
 */
package cn.lp.zyll.quartz.service.impl;

import cn.hutool.core.util.IdUtil;
import cn.lp.zyll.config.exception.BadRequestException;
...
//
    ...
    public QuartzJob findByUUid(String uuid) {
        QuartzJob byUUid = quartzJobRepository.findByUUid(uuid);
//        ValidationUtil.isNull(quartzJob.getId(),"QuartzJob","id",id);
        return byUUid;
    }
//
...
//    }
    ...
    public void delete(String uuid) {
            ...
            QuartzJob quartzJob = findByUUid(uuid);
            quartzManage.deleteJob(quartzJob);
            quartzJobRepository.delete(quartzJob);
